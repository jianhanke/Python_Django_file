...
def ckeck_event(ai_settings,screen,ship,bullets,stats,play_button,aliens,sb):
...
def check_bullet_alien_collisions(ai_settings,screen,ship,aliens,bullets,sb,stats):
	collidepoint=pygame.sprite.groupcollide(bullets,aliens,True,True)
	if collidepoint:
		stats.score+=ai_settings.aliens_points
		sb.prep_score()
...
def check_play_button(stats,play_button,mouse_x,mouse_y,ai_settings,screen,ship,aliens,bullets,sb):
	if play_button.rect.collidepoint(mouse_x,mouse_y):
		...
		if button_clicked and not stats.game_active:
			ai_settings.initizliaz_dynamic_settings()
